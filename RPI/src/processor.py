    ...
    def __process_output(self, outputs):
        ...
        for output in outputs:
            if output == "Extend Blocker":
                self.__expectation_handler.add("Confirm Blocker Extended", 100,  # TODO adjust timer
                ...
                self.__expectation_handler.add("Confirm Blocker Retracted", 100,  # TODO adjust timer
                                               "We did not receive confirmation for blocker extending.\n" +
                                               " Please make  sure the blocker is not obstructed by any objects and " +
                                               "that its sensors are in order.")
            elif output == "Push Pusher":
                self.__expectation_handler.add("Confirm Pusher Pushed", 100,  # TODO adjust timer
                                               "We did not receive confirmation for pusher pushing.\n" +
                                               "Please make sure the pusher is not obstructed by any objects and "
                                               "that its sensors are in order.")
                self.__expectation_handler.add("Secondary Motion", 100,  # TODO adjust timer
                ...
                self.__expectation_handler.add("Tertiary Motion", 100,  # TODO adjust timer
                ...
                self.__expectation_handler.add("Primary Color Detected", 100,  # TODO adjust timer
                ...
                if self.__current_color == Color.White:
                    self.__expectation_handler.add("Secondary White Detected", 100,  # TODO adjust timer
                    ...
                    self.__expectation_handler.add("Secondary Black Detected", 100,  # TODO adjust timer
