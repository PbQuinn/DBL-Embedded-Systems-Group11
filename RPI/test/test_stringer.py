...
class TestInit(TestCase):
    ...
    def test_string_disk(self):
        # pattern consisting of only 1, stringing 1:
        self.stringer = Stringer(1)
        ...
        # pattern consisting of only 1, stringing 0:
        self.stringer = Stringer(1)
    ...
    def test_to_string_exception(self):
        self.stringer = Stringer(11)
        self.stringer.stringed_disks = [1, 0, 1, 1]
